...
@interface RYMSkyEyeAASkyEyeMessagePackWriter : NSObject
{
    NSMutableData *_data;
}

+ (_Bool)writeObject:(id)arg1 context:(struct cmp_ctx_s *)arg2 options:(long long)arg3 error:(id *)arg4;
+ (void)packObject:(id)arg1 into:(struct cmp_ctx_s *)arg2;
