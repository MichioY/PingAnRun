...
@class NSArray, PAIMSDWebImageManager;

@interface PAIMSDWebImagePrefetcher : NSObject
{
    unsigned long long _options;
    id <PAIMSDWebImagePrefetcherDelegate> _delegate;
    PAIMSDWebImageManager *_manager;
...
@property(retain, nonatomic) PAIMSDWebImageManager *manager; // @synthesize manager=_manager;
@property(nonatomic) __weak id <PAIMSDWebImagePrefetcherDelegate> delegate; // @synthesize delegate=_delegate;
