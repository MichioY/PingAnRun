...
@interface PAZNWebViewJavascriptBridgeBase : NSObject
{
    id _webViewDelegate;
    long long _uniqueId;
    id <PAZNWebViewJavascriptBridgeBaseDelegate> _delegate;
...
@property(nonatomic) __weak id <PAZNWebViewJavascriptBridgeBaseDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
