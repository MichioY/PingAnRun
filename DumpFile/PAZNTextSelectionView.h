...
@class NSArray, NSMutableArray, NSTimer, PAZNSelectionGrabber, UIColor;
...
@interface PAZNTextSelectionView : UIView
{
    ...
    UIView *_caretView;
    PAZNSelectionGrabber *_startGrabber;
    PAZNSelectionGrabber *_endGrabber;
    NSTimer *_caretTimer;
...
@property(retain, nonatomic) PAZNSelectionGrabber *endGrabber; // @synthesize endGrabber=_endGrabber;
@property(retain, nonatomic) PAZNSelectionGrabber *startGrabber; // @synthesize startGrabber=_startGrabber;
