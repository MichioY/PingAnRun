...
@interface KSHCameraController : NSObject <AVCaptureVideoDataOutputSampleBufferDelegate, AVCaptureAudioDataOutputSampleBufferDelegate, AVCaptureMetadataOutputObjectsDelegate>
{
    _Bool bInProcessing;
    _Bool bHasResult;
    _Bool bFirstTime;
    ...
    _Bool _isWriting;
    _Bool _firstSample;
    id <KSHCameraControllerDelegate> _delegate;
    AVCaptureSession *_captureSession;
    double _recordedDuration;
    NSString *_sessionPreset;
    id <KSHImageTarget> _imageTarget;
    id <KSHRecDelegate> _recDelegate;
...
@property(nonatomic) __weak id <KSHRecDelegate> recDelegate; // @synthesize recDelegate=_recDelegate;
@property(nonatomic) __weak id <KSHImageTarget> imageTarget; // @synthesize imageTarget=_imageTarget;
...
@property(nonatomic) __weak id <KSHCameraControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (void)setDefaultPrompt;
- (void)doRec:(struct __CVBuffer *)arg1;
