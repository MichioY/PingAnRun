...
@class PAZNMASLayoutConstraint, PAZNMASViewAttribute, UIView;
...
@interface PAZNMASViewConstraint : PAZNMASConstraint <NSCopying>
{
    ...
    PAZNMASViewAttribute *_firstViewAttribute;
    PAZNMASViewAttribute *_secondViewAttribute;
    UIView *_installedView;
    PAZNMASLayoutConstraint *_layoutConstraint;
...
@property(nonatomic) __weak PAZNMASLayoutConstraint *layoutConstraint; // @synthesize layoutConstraint=_layoutConstraint;
@property(nonatomic) __weak UIView *installedView; // @synthesize installedView=_installedView;
@property(retain, nonatomic) PAZNMASViewAttribute *secondViewAttribute; // @synthesize secondViewAttribute=_secondViewAttribute;
@property(readonly, nonatomic) PAZNMASViewAttribute *firstViewAttribute; // @synthesize firstViewAttribute=_firstViewAttribute;
- (void).cxx_destruct;
- (void)uninstall;
