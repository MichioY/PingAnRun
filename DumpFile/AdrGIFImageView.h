...
@class AdrGIFImage, CADisplayLink, NSString, UIImage;

@interface AdrGIFImageView : UIImageView
{
    NSString *_runLoopMode;
    CADisplayLink *_displayLink;
    AdrGIFImage *_animatedImage;
    double _accumulator;
...
@property(retain, nonatomic) AdrGIFImage *animatedImage; // @synthesize animatedImage=_animatedImage;
