...
@class NSObject<OS_dispatch_group>, NSObject<OS_dispatch_queue>, NSOperationQueue, NSURL, NSURLCredential, PHAFHTTPRequestSerializer<PHAFURLRequestSerialization>, PHAFHTTPResponseSerializer<PHAFURLResponseSerialization>, PHAFNetworkReachabilityManager, PHAFSecurityPolicy;

@interface PHAFHTTPRequestOperationManager : NSObject <NSSecureCoding, NSCopying>
{
    _Bool _shouldUseCredentialStorage;
    NSURL *_baseURL;
    PHAFHTTPRequestSerializer<PHAFURLRequestSerialization> *_requestSerializer;
    PHAFHTTPResponseSerializer<PHAFURLResponseSerialization> *_responseSerializer;
    NSOperationQueue *_operationQueue;
    NSURLCredential *_credential;
    PHAFSecurityPolicy *_securityPolicy;
    PHAFNetworkReachabilityManager *_reachabilityManager;
...
@property(retain, nonatomic) PHAFNetworkReachabilityManager *reachabilityManager; // @synthesize reachabilityManager=_reachabilityManager;
...
@property(retain, nonatomic) PHAFHTTPResponseSerializer<PHAFURLResponseSerialization> *responseSerializer; // @synthesize responseSerializer=_responseSerializer;
@property(retain, nonatomic) PHAFHTTPRequestSerializer<PHAFURLRequestSerialization> *requestSerializer; // @synthesize requestSerializer=_requestSerializer;
