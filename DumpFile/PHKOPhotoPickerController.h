...
@class NSMutableArray, NSString, PHKOAlbumModel, PHKOCollectionView, UIButton, UIImagePickerController, UIImageView, UILabel;

@interface PHKOPhotoPickerController : UIViewController <UICollectionViewDataSource, UICollectionViewDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIAlertViewDelegate>
{
    ...
    PHKOAlbumModel *_model;
    CDUnknownBlockType _backButtonClickHandle;
    PHKOCollectionView *_collectionView;
...
@property(retain, nonatomic) PHKOCollectionView *collectionView; // @synthesize collectionView=_collectionView;
...
@property(retain, nonatomic) PHKOAlbumModel *model; // @synthesize model=_model;
