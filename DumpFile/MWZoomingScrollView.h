...
@class CAShapeLayer, DACircularProgressView, MWCaptionView, MWPhotoBrowser, MWTapDetectingImageView, MWTapDetectingView, NSString, PARSPhotoCutView, UIButton, UIImageView, UIView;
...
@interface MWZoomingScrollView : UIScrollView <UIScrollViewDelegate, MWTapDetectingImageViewDelegate, MWTapDetectingViewDelegate>
{
    ...
    PARSPhotoCutView *_cutView;
    int _moveCorner;
    CAShapeLayer *_fillLayer;
    UIView *_shadowView;
    _Bool _hasAddCutView;
...
- (int)judgeIsFourCornerTouch:(struct CGPoint)arg1;
- (struct CGPoint)getFourthCorner;
- (struct CGPoint)getThirdCorner;
- (struct CGPoint)getSecondCorner;
- (struct CGPoint)getFirstCorner;
