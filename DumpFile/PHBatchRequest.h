...
@interface PHBatchRequest : NSObject <PHRequestDelegate>
{
    NSArray *_requestArray;
    id <PHBatchRequestDelegate> _delegate;
...
@property(nonatomic) __weak id <PHBatchRequestDelegate> delegate; // @synthesize delegate=_delegate;
