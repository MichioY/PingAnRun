...
#import "PAIMXMPPRoomMessage.h"

@class NSDate, NSNumber, NSString, PAIMXMPPJID, PAIMXMPPMessage;

@interface PAIMXMPPRoomMessageHybridCoreDataStorageObject : NSManagedObject <PAIMXMPPRoomMessage>
{
}

@property(retain, nonatomic) NSString *messageStr; // @dynamic messageStr;
@property(retain, nonatomic) PAIMXMPPMessage *message; // @dynamic message;
...
@property(retain, nonatomic) PAIMXMPPMessage *primitiveMessage; // @dynamic primitiveMessage;
