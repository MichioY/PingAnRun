...
@interface PARSHealthCircleModifyMemberNickNameRequest : PARSHealthCircleBaseRequest
{
    NSString *_circleId;
    NSString *_memberId;
    NSString *_nickName;
...
- (id)httpBody;
- (id)url;
- (id)initWithUserId:(id)arg1 circleId:(id)arg2 memberId:(id)arg3 nickName:(id)arg4 completion:(CDUnknownBlockType)arg5;
