...
@class NSDate, NSString, NSTimer, PAIMDACircularProgressView, UIFont, UILabel;

@interface PAIMMBProgressHUD : UIView
{
    int mode;
    int animationType;
    ...
    PAIMDACircularProgressView *loadingIndicator;
    UILabel *downloadingLabel;
    float totoalProgress;
    float rosterProgress;
    float groupListProgress;
    float groupMemberProgress;
}

+ (_Bool)hideHUDInView:(id)arg1 animated:(_Bool)arg2 andTitle:(id)arg3 afterDelay:(double)arg4;
+ (_Bool)hideHUDInView:(id)arg1 animated:(_Bool)arg2 andTitle:(id)arg3;
+ (_Bool)hideFirstHUDForView:(id)arg1 animated:(_Bool)arg2;
+ (id)showFirstHUDAddedTo:(id)arg1 animated:(_Bool)arg2 withMessage:(id)arg3;
+ (_Bool)hideHUDForView:(id)arg1 animated:(_Bool)arg2;
+ (id)showHUDAddedTo:(id)arg1 animated:(_Bool)arg2 withMessage:(id)arg3;
...
- (void)updateRosterProgress:(id)arg1;
- (void)updateGroupListProgress:(id)arg1;
- (void)updateGroupMemberProgress:(id)arg1;
- (id)initForFirstLogin:(id)arg1;
