...
#import "PHAFMultipartFormData.h"

@class NSMutableURLRequest, NSString, PHAFMultipartBodyStream;

@interface PHAFStreamingMultipartFormData : NSObject <PHAFMultipartFormData>
{
    NSMutableURLRequest *_request;
    unsigned long long _stringEncoding;
    NSString *_boundary;
    PHAFMultipartBodyStream *_bodyStream;
}

@property(retain, nonatomic) PHAFMultipartBodyStream *bodyStream; // @synthesize bodyStream=_bodyStream;
