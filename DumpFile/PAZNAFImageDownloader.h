...
@class NSMutableArray, NSMutableDictionary, NSObject<OS_dispatch_queue>, PAZNAFHTTPSessionManager;

@interface PAZNAFImageDownloader : NSObject
{
    id <PAZNAFImageRequestCache> _imageCache;
    PAZNAFHTTPSessionManager *_sessionManager;
...
@property(retain, nonatomic) PAZNAFHTTPSessionManager *sessionManager; // @synthesize sessionManager=_sessionManager;
@property(retain, nonatomic) id <PAZNAFImageRequestCache> imageCache; // @synthesize imageCache=_imageCache;
- (void).cxx_destruct;
