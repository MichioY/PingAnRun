...
@class CADisplayLink, PAIMFLAnimatedImage, UIImage;

@interface PAIMFLAnimatedImageView : UIImageView
{
    _Bool _shouldAnimate;
    _Bool _needsDisplayWhenImageBecomesAvailable;
    PAIMFLAnimatedImage *_animatedImage;
...
@property(retain, nonatomic) PAIMFLAnimatedImage *animatedImage; // @synthesize animatedImage=_animatedImage;
- (void).cxx_destruct;
