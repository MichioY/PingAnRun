...
@class AdrCSToastStyle;

@interface AdrCSToastManager : NSObject
{
    _Bool _tapToDismissEnabled;
    _Bool _queueEnabled;
    AdrCSToastStyle *_sharedStyle;
...
@property(retain, nonatomic) AdrCSToastStyle *sharedStyle; // @synthesize sharedStyle=_sharedStyle;
- (void).cxx_destruct;
- (id)init;
