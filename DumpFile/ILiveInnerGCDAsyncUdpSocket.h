...
@class ILiveInnerGCDAsyncUdpSendPacket, NSData, NSMutableArray, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSString;

@interface ILiveInnerGCDAsyncUdpSocket : NSObject
{
    id delegate;
    ...
    ILiveInnerGCDAsyncUdpSendPacket *currentSend;
