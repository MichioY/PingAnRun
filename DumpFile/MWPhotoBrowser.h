...
@class MBProgressHUD, MPMoviePlayerViewController, MWGridViewController, NSArray, NSMutableArray, NSMutableSet, NSString, NSTimer, UIActivityIndicatorView, UIActivityViewController, UIBarButtonItem, UIButton, UIColor, UIImage, UIScrollView, UIToolbar;

@interface MWPhotoBrowser : PARSBaseViewController <UIScrollViewDelegate, UIActionSheetDelegate>
{
...
@property(nonatomic) long long selectedPhotoCount; // @synthesize selectedPhotoCount=_selectedPhotoCount;
...
- (_Bool)setPhotoSelected:(_Bool)arg1 atIndex:(unsigned long long)arg2;
...
- (_Bool)checkPhotoIsEnough:(_Bool)arg1;
