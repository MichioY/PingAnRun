...
@property(retain) NSString *fileExt; // @synthesize fileExt=_fileExt;
@property(retain) NSString *mediaDataUrl; // @synthesize mediaDataUrl=_mediaDataUrl;
@property(retain) NSString *extInfo; // @synthesize extInfo=_extInfo;
