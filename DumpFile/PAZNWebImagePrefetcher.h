...
@class NSArray, NSObject<OS_dispatch_queue>, PAZNWebImageManager;

@interface PAZNWebImagePrefetcher : NSObject
{
    PAZNWebImageManager *_manager;
    unsigned long long _options;
    NSObject<OS_dispatch_queue> *_prefetcherQueue;
    id <PAZNWebImagePrefetcherDelegate> _delegate;
...
@property(nonatomic) __weak id <PAZNWebImagePrefetcherDelegate> delegate; // @synthesize delegate=_delegate;
@property(nonatomic) NSObject<OS_dispatch_queue> *prefetcherQueue; // @synthesize prefetcherQueue=_prefetcherQueue;
@property(nonatomic) unsigned long long options; // @synthesize options=_options;
@property(retain, nonatomic) PAZNWebImageManager *manager; // @synthesize manager=_manager;
- (void).cxx_destruct;
