...
@class PAIMXMPPIDTracker;

@interface PAIMXMPPLastActivity : PAIMXMPPModule
{
    _Bool _respondsToQueries;
    PAIMXMPPIDTracker *_queryTracker;
}

@property(retain) PAIMXMPPIDTracker *queryTracker; // @synthesize queryTracker=_queryTracker;
- (void).cxx_destruct;
