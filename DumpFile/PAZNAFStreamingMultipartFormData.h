...
#import "PAZNAFMultipartFormData.h"

@class NSMutableURLRequest, NSString, PAZNAFMultipartBodyStream;

@interface PAZNAFStreamingMultipartFormData : NSObject <PAZNAFMultipartFormData>
{
    NSMutableURLRequest *_request;
    unsigned long long _stringEncoding;
    NSString *_boundary;
    PAZNAFMultipartBodyStream *_bodyStream;
}

@property(retain, nonatomic) PAZNAFMultipartBodyStream *bodyStream; // @synthesize bodyStream=_bodyStream;
