...
@class NSObject<OS_dispatch_group>, NSObject<OS_dispatch_queue>, NSOperationQueue, NSURL, NSURLCredential, PAZQOPHTTPRequestSerializer<PAZQOPURLRequestSerialization>, PAZQOPHTTPResponseSerializer<PAZQOPURLResponseSerialization>, PAZQOPNetworkReachabilityManager, PAZQOPSecurityPolicy;

@interface PAZQOPHTTPRequestOperationManager : NSObject <NSSecureCoding, NSCopying>
{
    _Bool _shouldUseCredentialStorage;
    NSURL *_baseURL;
    PAZQOPHTTPRequestSerializer<PAZQOPURLRequestSerialization> *_requestSerializer;
    PAZQOPHTTPResponseSerializer<PAZQOPURLResponseSerialization> *_responseSerializer;
    NSOperationQueue *_operationQueue;
    NSURLCredential *_credential;
    PAZQOPSecurityPolicy *_securityPolicy;
    PAZQOPNetworkReachabilityManager *_reachabilityManager;
...
@property(retain, nonatomic) PAZQOPNetworkReachabilityManager *reachabilityManager; // @synthesize reachabilityManager=_reachabilityManager;
@property(retain, nonatomic) PAZQOPSecurityPolicy *securityPolicy; // @synthesize securityPolicy=_securityPolicy;
...
@property(retain, nonatomic) PAZQOPHTTPResponseSerializer<PAZQOPURLResponseSerialization> *responseSerializer; // @synthesize responseSerializer=_responseSerializer;
@property(retain, nonatomic) PAZQOPHTTPRequestSerializer<PAZQOPURLRequestSerialization> *requestSerializer; // @synthesize requestSerializer=_requestSerializer;
