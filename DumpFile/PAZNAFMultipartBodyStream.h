...
@class NSEnumerator, NSError, NSMutableArray, NSMutableData, NSOutputStream, NSString, PAZNAFHTTPBodyPart;

@interface PAZNAFMultipartBodyStream : NSInputStream <NSCopying, NSStreamDelegate>
{
    ...
    PAZNAFHTTPBodyPart *_currentHTTPBodyPart;
...
@property(retain, nonatomic) PAZNAFHTTPBodyPart *currentHTTPBodyPart; // @synthesize currentHTTPBodyPart=_currentHTTPBodyPart;
