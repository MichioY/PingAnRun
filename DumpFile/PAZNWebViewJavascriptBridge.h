...
@class NSString, PAZNWebViewJavascriptBridgeBase, UIWebView;

@interface PAZNWebViewJavascriptBridge : NSObject <UIWebViewDelegate, PAZNWebViewJavascriptBridgeBaseDelegate>
{
    UIWebView *_webView;
    id _webViewDelegate;
    long long _uniqueId;
