...
#import "NSCoding.h"
#import "PAZNTextAsyncLayerDelegate.h"
#import "PAZNTextDebugTarget.h"

@class NSArray, NSAttributedString, NSMutableArray, NSMutableAttributedString, NSString, NSTimer, PAZNTextContainer, PAZNTextDebugOption, PAZNTextHighlight, PAZNTextLayout, UIBezierPath, UIColor, UIFont;

@interface PAZNLabel : UIView <PAZNTextDebugTarget, PAZNTextAsyncLayerDelegate, NSCoding>
{
    ...
    PAZNTextLayout *_shrinkInnerLayout;
    PAZNTextLayout *_shrinkHighlightLayout;
    ...
    PAZNTextDebugOption *_debugOption;
...
@property(copy, nonatomic) PAZNTextDebugOption *debugOption; // @synthesize debugOption=_debugOption;
...
@property(retain, nonatomic) PAZNTextLayout *textLayout;
