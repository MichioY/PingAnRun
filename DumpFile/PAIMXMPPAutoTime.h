...
@class NSData, NSDate, NSObject<OS_dispatch_source>, PAIMXMPPJID, PAIMXMPPTime;

@interface PAIMXMPPAutoTime : PAIMXMPPModule
{
    double recalibrationInterval;
    PAIMXMPPJID *targetJID;
    double timeDifference;
    unsigned long long lastCalibrationTime;
    NSObject<OS_dispatch_source> *recalibrationTimer;
    _Bool awaitingQueryResponse;
    PAIMXMPPTime *xmppTime;
...
@property(retain) PAIMXMPPJID *targetJID;
