...
#import "PHRequestDelegate.h"

@class NSMutableArray, NSString;

@interface PHChainRequest : NSObject <PHRequestDelegate>
{
    id <PHChainRequestDelegate> _delegate;
...
@property(nonatomic) __weak id <PHChainRequestDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
