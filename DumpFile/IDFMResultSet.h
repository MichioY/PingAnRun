...
@class IDFMDatabase, IDFMStatement, NSMutableDictionary, NSString;

@interface IDFMResultSet : NSObject
{
    IDFMDatabase *_parentDB;
    IDFMStatement *_statement;
    NSString *_query;
...
@property(retain) IDFMStatement *statement; // @synthesize statement=_statement;
