...
@class NSEnumerator, NSError, NSMutableArray, NSMutableData, NSOutputStream, NSString, PAZQOPHTTPBodyPart;

@interface PAZQOPMultipartBodyStream : NSInputStream <NSCopying, NSStreamDelegate>
{
    ...
    PAZQOPHTTPBodyPart *_currentHTTPBodyPart;
...
@property(retain, nonatomic) PAZQOPHTTPBodyPart *currentHTTPBodyPart; // @synthesize currentHTTPBodyPart=_currentHTTPBodyPart;
