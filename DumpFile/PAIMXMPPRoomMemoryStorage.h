...
#import "PAIMXMPPRoomStorage.h"

@class NSMutableArray, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSString, PAIMXMPPRoom;

@interface PAIMXMPPRoomMemoryStorage : NSObject <PAIMXMPPRoomStorage>
{
    PAIMXMPPRoom *parent;
...
@property(readonly) PAIMXMPPRoom *parent;
- (void)dealloc;
