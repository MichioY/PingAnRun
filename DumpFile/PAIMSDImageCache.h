...
@interface PAIMSDImageCache : NSObject
{
...
- (void).cxx_destruct;
- (id)SDImageCachePathForKey:(id)arg1;
...
- (void)storeImage:(id)arg1 recalculateFromImage:(_Bool)arg2 imageData:(id)arg3 forKey:(id)arg4 toDisk:(_Bool)arg5 async:(_Bool)arg6;
