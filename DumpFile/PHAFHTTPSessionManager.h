...
#import "PHAFURLSessionManager.h"

#import "NSCopying.h"
#import "NSSecureCoding.h"

@class NSURL, PHAFHTTPRequestSerializer<PHAFURLRequestSerialization>, PHAFHTTPResponseSerializer<PHAFURLResponseSerialization>;

@interface PHAFHTTPSessionManager : PHAFURLSessionManager <NSSecureCoding, NSCopying>
{
    NSURL *_baseURL;
...
@property(retain, nonatomic) PHAFHTTPResponseSerializer<PHAFURLResponseSerialization> *responseSerializer; // @dynamic responseSerializer;
