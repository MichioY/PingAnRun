...
@class NSString, PAIMXMPPIDTracker, PAIMXMPPJID;

@interface PAIMXMPPRoom : PAIMXMPPModule
{
    id <PAIMXMPPRoomStorage> xmppRoomStorage;
    PAIMXMPPJID *roomJID;
    PAIMXMPPJID *myRoomJID;
    NSString *myNickname;
    NSString *roomSubject;
    PAIMXMPPIDTracker *responseTracker;
...
@property(readonly) PAIMXMPPJID *myRoomJID;
@property(readonly) PAIMXMPPJID *roomJID;
@property(readonly) id <PAIMXMPPRoomStorage> xmppRoomStorage;
