...
- (id)description;
- (id)observerError:(CDUnknownBlockType)arg1 completed:(CDUnknownBlockType)arg2;
- (id)observerNext:(CDUnknownBlockType)arg1 error:(CDUnknownBlockType)arg2;
- (id)observerCompleted:(CDUnknownBlockType)arg1;
- (id)observerError:(CDUnknownBlockType)arg1;
- (id)observerNext:(CDUnknownBlockType)arg1 error:(CDUnknownBlockType)arg2 completed:(CDUnknownBlockType)arg3;
- (id)observerNext:(CDUnknownBlockType)arg1 completed:(CDUnknownBlockType)arg2;
- (id)observerNext:(CDUnknownBlockType)arg1;
- (id)zipWith:(id)arg1;
- (id)concat:(id)arg1;
