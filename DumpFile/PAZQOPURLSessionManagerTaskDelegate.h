...
@class NSMutableData, NSProgress, NSString, NSURL, PAZQOPURLSessionManager;

@interface PAZQOPURLSessionManagerTaskDelegate : NSObject <NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate>
{
    PAZQOPURLSessionManager *_manager;
...
@property(nonatomic) __weak PAZQOPURLSessionManager *manager; // @synthesize manager=_manager;
- (void).cxx_destruct;
