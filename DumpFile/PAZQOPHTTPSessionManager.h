...
#import "PAZQOPURLSessionManager.h"

#import "NSCopying.h"
#import "NSSecureCoding.h"

@class NSURL, PAZQOPHTTPRequestSerializer<PAZQOPURLRequestSerialization>, PAZQOPHTTPResponseSerializer<PAZQOPURLResponseSerialization>;

@interface PAZQOPHTTPSessionManager : PAZQOPURLSessionManager <NSSecureCoding, NSCopying>
{
    NSURL *_baseURL;
...
@property(retain, nonatomic) PAZQOPHTTPResponseSerializer<PAZQOPURLResponseSerialization> *responseSerializer; // @dynamic responseSerializer;
