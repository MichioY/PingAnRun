...
@class NSDate, NSString, PAIMDDXMLElement, PAIMXMPPJID;

@interface PAIMXMPPProcessOne : PAIMXMPPModule
{
    PAIMDDXMLElement *pushConfiguration;
...
@property(retain) PAIMDDXMLElement *pushConfiguration;
@property(retain) NSDate *savedSessionDate;
@property(retain) PAIMXMPPJID *savedSessionJID;
