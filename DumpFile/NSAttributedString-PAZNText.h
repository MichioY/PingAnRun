...
@class NSArray, NSDictionary, NSNumber, NSParagraphStyle, NSShadow, NSString, PAZNTextBorder, PAZNTextDecoration, PAZNTextShadow, UIColor, UIFont;
...
@property(readonly, nonatomic) PAZNTextBorder *yy_textBackgroundBorder;
- (id)yy_textBorderAtIndex:(unsigned long long)arg1;
@property(readonly, nonatomic) PAZNTextBorder *yy_textBorder;
- (id)yy_textStrikethroughAtIndex:(unsigned long long)arg1;
@property(readonly, nonatomic) PAZNTextDecoration *yy_textStrikethrough;
- (id)yy_textUnderlineAtIndex:(unsigned long long)arg1;
@property(readonly, nonatomic) PAZNTextDecoration *yy_textUnderline;
- (id)yy_textInnerShadowAtIndex:(unsigned long long)arg1;
@property(readonly, nonatomic) PAZNTextShadow *yy_textInnerShadow;
- (id)yy_textShadowAtIndex:(unsigned long long)arg1;
@property(readonly, nonatomic) PAZNTextShadow *yy_textShadow;
