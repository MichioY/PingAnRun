...
#import "PAZNTextDebugTarget.h"
#import "PAZNTextKeyboardObserver.h"
#import "UIAlertViewDelegate.h"
#import "UIScrollViewDelegate.h"
#import "UITextInput.h"

@class NSArray, NSAttributedString, NSDataDetector, NSDictionary, NSMutableArray, NSMutableAttributedString, NSString, NSTimer, PAZNTextContainer, PAZNTextContainerView, PAZNTextDebugOption, PAZNTextHighlight, PAZNTextLayout, PAZNTextMagnifier, PAZNTextRange, PAZNTextSelectionView, UIColor, UIFont, UIImageView, UITextPosition, UITextRange, UIView;

@interface PAZNTextView : UIScrollView <UIScrollViewDelegate, UIAlertViewDelegate, PAZNTextDebugTarget, PAZNTextKeyboardObserver, UITextInput>
{
    PAZNTextRange *_selectedTextRange;
    PAZNTextRange *_markedTextRange;
    id <PAZNTextViewDelegate> _outerDelegate;
    UIImageView *_placeHolderView;
    NSMutableAttributedString *_innerText;
    NSMutableAttributedString *_delectedText;
    PAZNTextContainer *_innerContainer;
    PAZNTextLayout *_innerLayout;
    PAZNTextContainerView *_containerView;
    PAZNTextSelectionView *_selectionView;
    PAZNTextMagnifier *_magnifierCaret;
    PAZNTextMagnifier *_magnifierRanged;
    NSMutableAttributedString *_typingAttributesHolder;
    NSDataDetector *_dataDetector;
    double _magnifierRangedOffset;
    struct _NSRange _highlightRange;
    PAZNTextHighlight *_highlight;
    PAZNTextLayout *_highlightLayout;
    PAZNTextRange *_trackingRange;
    ...
    id <PAZNTextParser> _textParser;
    NSString *_placeholderText;
    UIFont *_placeholderFont;
    UIColor *_placeholderTextColor;
    NSAttributedString *_placeholderAttributedText;
    NSArray *_exclusionPaths;
    id <PAZNTextLinePositionModifier> _linePositionModifier;
...
@property(copy, nonatomic) id <PAZNTextLinePositionModifier> linePositionModifier; // @synthesize linePositionModifier=_linePositionModifier;
...
@property(retain, nonatomic) id <PAZNTextParser> textParser; // @synthesize textParser=_textParser;
...
@property(nonatomic) __weak id <PAZNTextViewDelegate> delegate;
...
@property(readonly, nonatomic) PAZNTextLayout *textLayout;
@property(copy, nonatomic) PAZNTextDebugOption *debugOption;
- (void)setMenustate:(_Bool)arg1;
