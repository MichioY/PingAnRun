...
@interface PAZNClassInfo : NSObject
{
    _Bool _needUpdate;
    _Bool _isMeta;
    Class _cls;
...
@property(readonly, nonatomic) PAZNClassInfo *superClassInfo; // @synthesize superClassInfo=_superClassInfo;
