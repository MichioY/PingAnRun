...
@interface PHRSAManager : NSObject
{
...
- (struct __SecKey *)getPublickKeyFromString:(id)arg1;
- (struct __SecKey *)getPrivateKeyFromString:(id)arg1;
...
- (void)loadRivateKeyFromString:(id)arg1;
- (void)loadPublickKeyFromString:(id)arg1;
