...
@interface PALiveASValuePopUpView : UIView
{
    ...
    id <PALiveASValuePopUpViewDelegate> _delegate;
...
@property(nonatomic) __weak id <PALiveASValuePopUpViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (void)layoutSubviews;
