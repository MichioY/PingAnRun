...
#import "PAZNWebViewJavascriptBridgeBaseDelegate.h"
#import "WKNavigationDelegate.h"

@class NSString, PAZNWebViewJavascriptBridgeBase, WKWebView;

@interface PAZNWKWebViewJavascriptBridge : NSObject <WKNavigationDelegate, PAZNWebViewJavascriptBridgeBaseDelegate>
{
    WKWebView *_webView;
    id <WKNavigationDelegate> _webViewDelegate;
    long long _uniqueId;
    PAZNWebViewJavascriptBridgeBase *_base;
}
