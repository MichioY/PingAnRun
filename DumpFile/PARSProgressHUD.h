...
@interface PARSProgressHUD : UIView
{
    _Bool useAnimation;
    ...
    float progress;
    float _cornerRadius;
    id <PARSProgressHUDDelegate> delegate;
    UIColor *color;
    UIFont *labelFont;
    UIColor *labelColor;
...
+ (void)showWindowCoverMultilineInView:(id)arg1 withMessage:(id)arg2;
+ (void)showWindowCoverIndicatorInView:(id)arg1 withText:(id)arg2;
+ (void)showWindowCoverMultilineMessage:(id)arg1;
+ (void)showWindowCoverIndicatorWithText:(id)arg1;
+ (void)showCoverIndicatorInView:(id)arg1 withText:(id)arg2;
+ (void)hideIndicatorInView:(id)arg1;
+ (void)showAutoInView:(id)arg1 withText:(id)arg2;
+ (void)showAutoIndicatorInView:(id)arg1 withText:(id)arg2;
+ (void)showIndicatorInView:(id)arg1 withText:(id)arg2;
+ (void)showMultilineIndicatorMessage:(id)arg1;
+ (void)showIndicatorMessage:(id)arg1;
+ (void)hideDefaultIndicator;
+ (void)showDefaultIndicatorWithText:(id)arg1;
...
@property __weak id <PARSProgressHUDDelegate> delegate; // @synthesize delegate;
