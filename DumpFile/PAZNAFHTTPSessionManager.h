...
#import "PAZNAFURLSessionManager.h"

#import "NSCopying.h"
#import "NSSecureCoding.h"

@class NSURL, PAZNAFHTTPRequestSerializer<PAZNAFURLRequestSerialization>, PAZNAFHTTPResponseSerializer<PAZNAFURLResponseSerialization>;

@interface PAZNAFHTTPSessionManager : PAZNAFURLSessionManager <NSSecureCoding, NSCopying>
{
    NSURL *_baseURL;
    PAZNAFHTTPRequestSerializer<PAZNAFURLRequestSerialization> *_requestSerializer;
}

+ (_Bool)supportsSecureCoding;
+ (id)manager;
@property(retain, nonatomic) PAZNAFHTTPRequestSerializer<PAZNAFURLRequestSerialization> *requestSerializer; // @synthesize requestSerializer=_requestSerializer;
...
- (id)PAZNTCH:(id)arg1 parameters:(id)arg2 success:(CDUnknownBlockType)arg3 failure:(CDUnknownBlockType)arg4;
...
@property(retain, nonatomic) PAZNAFHTTPResponseSerializer<PAZNAFURLResponseSerialization> *responseSerializer; // @dynamic responseSerializer;
