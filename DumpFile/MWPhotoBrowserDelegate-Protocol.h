...
@class MWCaptionView, MWPhotoBrowser, NSString, UIImage;
...
@optional
- (void)photoIsEnough;
- (long long)photoBrowserSelectedPhotoCount:(MWPhotoBrowser *)arg1;
- (void)photoBrowserDidFinishModalPresentation:(MWPhotoBrowser *)arg1 videoIndex:(long long)arg2 cutImage:(UIImage *)arg3;
