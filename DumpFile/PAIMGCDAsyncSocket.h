...
@class NSData, NSMutableArray, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, PAIMGCDAsyncReadPacket, PAIMGCDAsyncSocketPreBuffer, PAIMGCDAsyncWritePacket;

@interface PAIMGCDAsyncSocket : NSObject
{
    unsigned int flags;
    ...
    PAIMGCDAsyncReadPacket *currentRead;
    PAIMGCDAsyncWritePacket *currentWrite;
    unsigned long long socketFDBytesAvailable;
    PAIMGCDAsyncSocketPreBuffer *preBuffer;
    CDStruct_4210025a streamContext;
    struct __CFReadStream *readStream;
    struct __CFWriteStream *writeStream;
    struct SSLContext *sslContext;
    PAIMGCDAsyncSocketPreBuffer *sslPreBuffer;
