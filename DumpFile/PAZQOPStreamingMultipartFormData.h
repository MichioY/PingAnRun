...
#import "PAZQOPMultipartFormData.h"

@class NSMutableURLRequest, NSString, PAZQOPMultipartBodyStream;

@interface PAZQOPStreamingMultipartFormData : NSObject <PAZQOPMultipartFormData>
{
    NSMutableURLRequest *_request;
    unsigned long long _stringEncoding;
    NSString *_boundary;
    PAZQOPMultipartBodyStream *_bodyStream;
}

@property(retain, nonatomic) PAZQOPMultipartBodyStream *bodyStream; // @synthesize bodyStream=_bodyStream;
