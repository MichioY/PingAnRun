...
@class CALayer, JKNScrollView, NSArray, NSDictionary, UIColor;

@interface JKNSegmentedControl : UIControl
{
    ...
    JKNScrollView *_scrollView;
    struct UIEdgeInsets _selectionIndicatorEdgeInsets;
    struct UIEdgeInsets _segmentEdgeInset;
}

@property(retain, nonatomic) JKNScrollView *scrollView; // @synthesize scrollView=_scrollView;
