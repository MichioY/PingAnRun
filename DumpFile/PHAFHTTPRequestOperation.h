...
#import "PHAFURLConnectionOperation.h"

@class NSError, NSHTTPURLResponse, NSRecursiveLock, PHAFHTTPResponseSerializer<PHAFURLResponseSerialization>;

@interface PHAFHTTPRequestOperation : PHAFURLConnectionOperation
{
