...
@class NSArray, NSAttributedString, NSSet, PAZNTextContainer, PAZNTextLine;

@interface PAZNTextLayout : NSObject <NSCoding>
{
    ...
    PAZNTextContainer *_container;
    NSAttributedString *_text;
    struct __CTFramesetter *_frameSetter;
    struct __CTFrame *_frame;
    NSArray *_lines;
    PAZNTextLine *_truncatedLine;
...
@property(retain, nonatomic) PAZNTextLine *truncatedLine; // @synthesize truncatedLine=_truncatedLine;
...
@property(retain, nonatomic) PAZNTextContainer *container; // @synthesize container=_container;
- (void).cxx_destruct;
