...
@interface AdrWebViewProgressView : UIView
{
    float _progress;
...
- (void).cxx_destruct;
- (void)dealloc;
- (void)setCompleteFullFrameWithAnimation:(_Bool)arg1;
- (void)fullFrameAnimation:(id)arg1;
- (void)setProgress:(float)arg1 animated:(_Bool)arg2 isFirstUse:(_Bool)arg3;
- (void)configureViews;
