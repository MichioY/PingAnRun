...
@class NSMutableData, NSProgress, NSString, NSURL, PHAFURLSessionManager;

@interface PHAFURLSessionManagerTaskDelegate : NSObject <NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate>
{
    PHAFURLSessionManager *_manager;
...
@property(nonatomic) __weak PHAFURLSessionManager *manager; // @synthesize manager=_manager;
- (void).cxx_destruct;
