...
@class NSArray, NSNumber, NSParagraphStyle, NSShadow, NSString, PAZNTextBorder, PAZNTextDecoration, PAZNTextShadow, UIColor, UIFont;
...
@property(retain, nonatomic) PAZNTextBorder *yy_textBackgroundBorder;
@property(retain, nonatomic) PAZNTextBorder *yy_textBorder;
@property(retain, nonatomic) PAZNTextDecoration *yy_textStrikethrough;
@property(retain, nonatomic) PAZNTextDecoration *yy_textUnderline;
@property(retain, nonatomic) PAZNTextShadow *yy_textInnerShadow;
@property(retain, nonatomic) PAZNTextShadow *yy_textShadow;
