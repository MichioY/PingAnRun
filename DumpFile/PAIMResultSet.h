...
@class NSMutableDictionary, NSString, PAIMDatabase, PAIMStatement;

@interface PAIMResultSet : NSObject
{
    PAIMDatabase *_parentDB;
    PAIMStatement *_statement;
    NSString *_query;
    NSMutableDictionary *_columnNameToIndexMap;
}

+ (id)resultSetWithStatement:(id)arg1 usingParentDatabase:(id)arg2;
@property(retain) PAIMStatement *statement; // @synthesize statement=_statement;
