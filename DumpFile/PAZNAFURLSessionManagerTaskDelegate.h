...
@class NSMutableData, NSProgress, NSString, NSURL, PAZNAFURLSessionManager;

@interface PAZNAFURLSessionManagerTaskDelegate : NSObject <NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate>
{
...
@property(nonatomic) __weak PAZNAFURLSessionManager *manager; // @synthesize manager=_manager;
- (void).cxx_destruct;
