...
@class NSMutableArray, PAZNTextDebugOption, PAZNTextLayout;

@interface PAZNTextContainerView : UIView
{
...
@property(retain, nonatomic) PAZNTextLayout *layout; // @synthesize layout=_layout;
