...
@class NSArray, NSLock, NSMutableDictionary, NSObject<OS_dispatch_group>, NSObject<OS_dispatch_queue>, NSOperationQueue, NSString, NSURLSession, NSURLSessionConfiguration, PAZNAFNetworkReachabilityManager, PAZNAFSecurityPolicy;

@interface PAZNAFURLSessionManager : NSObject <NSURLSessionDelegate, NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate, NSSecureCoding, NSCopying>
{
    _Bool _attemptsToRecreateUploadTasksForBackgroundSessions;
    NSURLSession *_session;
    NSOperationQueue *_operationQueue;
    id <PAZNAFURLResponseSerialization> _responseSerializer;
    PAZNAFSecurityPolicy *_securityPolicy;
    PAZNAFNetworkReachabilityManager *_reachabilityManager;
...
@property(retain, nonatomic) PAZNAFNetworkReachabilityManager *reachabilityManager; // @synthesize reachabilityManager=_reachabilityManager;
@property(retain, nonatomic) PAZNAFSecurityPolicy *securityPolicy; // @synthesize securityPolicy=_securityPolicy;
@property(retain, nonatomic) id <PAZNAFURLResponseSerialization> responseSerializer; // @synthesize responseSerializer=_responseSerializer;
...
- (id)progressForDataTask:(id)arg1;
...
- (id)uploadTaskWithStreamedRequest:(id)arg1 progress:(id *)arg2 sendDataHandler:(CDUnknownBlockType)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (id)uploadTaskWithStreamedRequest:(id)arg1 progress:(id *)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (id)uploadTaskWithRequest:(id)arg1 fromData:(id)arg2 progress:(id *)arg3 sendDataHandler:(CDUnknownBlockType)arg4 completionHandler:(CDUnknownBlockType)arg5;
- (id)uploadTaskWithRequest:(id)arg1 fromData:(id)arg2 progress:(id *)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (id)uploadTaskWithRequest:(id)arg1 fromFile:(id)arg2 progress:(id *)arg3 sendDataHandler:(CDUnknownBlockType)arg4 completionHandler:(CDUnknownBlockType)arg5;
- (id)uploadTaskWithRequest:(id)arg1 fromFile:(id)arg2 progress:(id *)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (id)dataTaskWithRequest:(id)arg1 progress:(id *)arg2 receiveDataHandler:(CDUnknownBlockType)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (void)addDelegateForUploadTask:(id)arg1 progress:(id *)arg2 sendDataHandler:(CDUnknownBlockType)arg3 completionHandler:(CDUnknownBlockType)arg4;
- (void)addDelegateForUploadTask:(id)arg1 progress:(id *)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)addDelegateForDataTask:(id)arg1 progress:(id *)arg2 receiveDataHandler:(CDUnknownBlockType)arg3 completionHandler:(CDUnknownBlockType)arg4;
