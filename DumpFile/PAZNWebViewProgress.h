...
@interface PAZNWebViewProgress : NSObject <UIWebViewDelegate>
{
    ...
    _Bool _interactive;
    float _progress;
    id <PAZNWebViewProgressDelegate> _progressDelegate;
...
@property(nonatomic) __weak id <PAZNWebViewProgressDelegate> progressDelegate; // @synthesize progressDelegate=_progressDelegate;
- (void).cxx_destruct;
