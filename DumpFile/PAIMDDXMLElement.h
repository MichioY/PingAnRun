...
#import "PAIMDDXMLNode.h"

@interface PAIMDDXMLElement : PAIMDDXMLNode
{
}
...
- (id)PAIMresultSet;
- (_Bool)PAIMhasResultSet;
- (_Bool)PAIMisResultSet;
...
- (void)addAttributeWithName:(id)arg1 unsignedIntegerValue:(long long)arg2;
