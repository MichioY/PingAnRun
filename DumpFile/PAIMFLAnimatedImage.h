...
@interface PAIMFLAnimatedImage : NSObject
{
    ...
    PAIMFLAnimatedImage *_weakProxy;
    struct CGSize _size;
}
...
+ (void)initialize;
@property(readonly, nonatomic) PAIMFLAnimatedImage *weakProxy; // @synthesize weakProxy=_weakProxy;
