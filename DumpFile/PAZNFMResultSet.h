...
@class NSMutableDictionary, NSString, PAZNFMDatabase, PAZNFMStatement;

@interface PAZNFMResultSet : NSObject
{
    PAZNFMDatabase *_parentDB;
    PAZNFMStatement *_statement;
    NSString *_query;
    NSMutableDictionary *_columnNameToIndexMap;
}

+ (id)resultSetWithStatement:(id)arg1 usingParentDatabase:(id)arg2;
@property(retain) PAZNFMStatement *statement; // @synthesize statement=_statement;
