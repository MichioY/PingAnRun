...
@class NSEnumerator, NSError, NSMutableArray, NSMutableData, NSOutputStream, NSString, PHAFHTTPBodyPart;

@interface PHAFMultipartBodyStream : NSInputStream <NSCopying, NSStreamDelegate>
{
    ...
    PHAFHTTPBodyPart *_currentHTTPBodyPart;
...
@property(retain, nonatomic) PHAFHTTPBodyPart *currentHTTPBodyPart; // @synthesize currentHTTPBodyPart=_currentHTTPBodyPart;
