...
@class NSArray, NSDate, NSMutableArray, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSString, PAIMGCDAsyncSocket, PAIMXMPPJID, PAIMXMPPStream;

@interface PAIMTURNSocket : NSObject
{
    int state;
    _Bool isClient;
