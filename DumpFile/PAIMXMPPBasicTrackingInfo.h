...
#import "PAIMXMPPTrackingInfo.h"

@class NSObject<OS_dispatch_source>, NSString, PAIMXMPPElement;

@interface PAIMXMPPBasicTrackingInfo : NSObject <PAIMXMPPTrackingInfo>
{
    id target;
    SEL selector;
    ...
    double timeout;
    NSString *elementID;
    PAIMXMPPElement *element;
    NSObject<OS_dispatch_source> *timer;
}

@property(copy, nonatomic) PAIMXMPPElement *element; // @synthesize element;
