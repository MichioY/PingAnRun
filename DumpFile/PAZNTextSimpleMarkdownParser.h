...
@class NSMutableArray, NSRegularExpression, NSString, PAZNTextBorder, UIColor, UIFont;

@interface PAZNTextSimpleMarkdownParser : NSObject <PAZNTextParser>
{
    UIFont *_font;
