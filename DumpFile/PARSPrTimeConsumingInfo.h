...
@interface PARSPrTimeConsumingInfo : NSObject <PARSPrMonitorInfoProtocol>
{
    float _cpuUsage;
    NSString *_pageName;
    NSString *_prePageName;
    double _timeConsuming;
    long long _uniqueId;
    NSDate *_time;
    NSString *_deviceG23;
    NSString *_clientIp;
...
@property(nonatomic) double timeConsuming; // @synthesize timeConsuming=_timeConsuming;
