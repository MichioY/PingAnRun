...
#import "PAZNWebViewProgressDelegate.h"
#import "UIWebViewDelegate.h"
#import "WKNavigationDelegate.h"
#import "WKUIDelegate.h"

@class NSString, NSURL, NSURLRequest, PAZNWebViewProgress, UIScrollView;

@interface PAZNWebView : UIView <UIWebViewDelegate, WKNavigationDelegate, WKUIDelegate, PAZNWebViewProgressDelegate>
{
    _Bool _scalesPageToFit;
    _Bool _usingUIWebView;
    id <PAZNWebViewDelegate> _delegate;
    id _realWebView;
    ...
    PAZNWebViewProgress *_njkWebViewProgress;
...
@property(retain, nonatomic) PAZNWebViewProgress *njkWebViewProgress; // @synthesize njkWebViewProgress=_njkWebViewProgress;
...
@property(nonatomic) __weak id <PAZNWebViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
