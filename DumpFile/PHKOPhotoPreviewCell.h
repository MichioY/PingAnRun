...
@class NSString, PHKOAssetModel, UIImageView, UIScrollView, UIView;

@interface PHKOPhotoPreviewCell : UICollectionViewCell <UIGestureRecognizerDelegate, UIScrollViewDelegate>
{
    double _aspectRatio;
