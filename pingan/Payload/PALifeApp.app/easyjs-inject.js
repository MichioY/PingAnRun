...
invokeCallback2: function (cbID, removeAfterExecute){
    var args = Array.prototype.slice.call(arguments);
    args.shift();
    args.shift();
    ...
    var stringJson = {};
    if(args){
        stringJson = JSON.parse(args[0]);
    }
    return cb.apply(null, [stringJson]);
},
	...
	inject: function (obj, methods){
		...
		for (var i = 0, l = methods.length; i < l; i++){
			(function (){
                ...
                //var name = method.split(":")[0]?method.split(":")[0]:method;
